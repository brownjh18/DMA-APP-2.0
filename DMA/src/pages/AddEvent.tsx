    ...
    <IonPage>
      <IonHeader translucent>
        <IonToolbar className="toolbar-ios">
          ...
          <IonTitle className="title-ios" style={{ textAlign: 'left', marginLeft: '-28px' }}>Add Event</IonTitle>
        </IonToolbar>
      </IonHeader>
            ...
            <div className="af-card" style={{ padding: 0, overflow: 'hidden' }}>
              ...
              <div style={{ padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span className="af-upload-text" style={{ margin: 0 }}>{formData.thumbnailFile?.name}</span>
                </div>
                <button
