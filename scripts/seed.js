...
const seedData = async () => {
  try {
    ...
    // Clear only seeded devotions (those with author 'Dove Church')
    const seededDevotionsDeleted = await Devotion.deleteMany({ author: 'Dove Church' });
    ...
    const events = [
      ...
      },
      {
        ...
        category: 'service',
        speaker: 'Dove Church Leadership',
    ...
    const ministries = [
      {
        ...
        contactEmail: 'marriedcouples@dovechurch.org',
      ...
      },
      {
        ...
        contactEmail: 'youth@dovechurch.org',
      ...
      },
      {
        ...
        contactEmail: 'children@dovechurch.org',
        contactPhone: '+256 772824677',
        category: 'children',
        memberCount: 95,
        isActive: true,
      ...
      },
      {
        ...
        contactEmail: 'evangelism@dovechurch.org',
        contactPhone: '+256 700116734',
        category: 'evangelism',
        memberCount: 45,
        isActive: true,
      ...
      },
      {
        ...
        contactEmail: 'prayer@dovechurch.org',
        contactPhone: '+256 772824677',
      ...
      },
      {
        ...
        contactEmail: 'worship@dovechurch.org',
        contactPhone: '+256 700116734',
        category: 'worship',
        memberCount: 35,
        isActive: true,
    ...
    const contact = new Contact({
      ...
      phone: '+256 772824677',
      email: 'info@dovechurch.org',
      serviceTimes: 'Sundays: 8:00 AM & 10:30 AM\nWednesdays: 7:00 PM',
      about: 'Transforming lives through faith, community, and service since 2005. Founded in 2005 by Pastor Daniel and Erica Kaggwa.',
...
if (require.main === module) {
  ...
  if (args.includes('--update-durations')) {
    ...
    mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/dove-church', {
