...
router.post('/', authenticateToken, requireAdmin, async (req, res) => {
  try {
    ...
    const contactData = {
      churchName: churchName || 'Dove Church',
      address: address || '123 Faith Street, Kampala, Uganda',
      phone: phone || '+256 123 456 789',
      email: email || 'info@dovechurch.org',
      serviceTimes: serviceTimes || 'Sundays: 8:00 AM & 10:30 AM\nWednesdays: 7:00 PM',
      about: about || 'Dove Church is a vibrant church community dedicated to spreading God\'s love and serving our community through worship, fellowship, and outreach programs.',
